...
// PERBAIKAN: Gunakan variabel environment atau default string yang PASTI SAMA dengan middleware
...
exports.login = async (req, res) => {
  try {
    ...
    // Membuat token dengan kunci rahasia yang benar
    ...
    res.json({
      ...
      token: token,
      user: payload // Mengirimkan data user ke frontend
    });
